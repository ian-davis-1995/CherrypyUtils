...
class DatabaseModel(cherrypy.Tool):
    def __init__(self, model_name, database_name):
        cherrypy.Tool.__init__(self, "on_start_resource", self.initialize, priority=10)
    ...
    def _setup(self):
        ...
        cherrypy.request.hooks.attach("on_end_resource", self.on_session_ended, priority=90)
